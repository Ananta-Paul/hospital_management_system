  ...
  const newsItems = [
    {
      date: "14 May 24",
      title:
        "Apollo Hospitals in Indore Introduces Central India’s First CORI Hip...",
      description:
        "Taking care delivery to the next level in Central India, Apollo Hospitals, Indore...",
    ...
    },
    {
      date: "25 Apr 24",
      title:
        "Apollo Hospitals Group becomes the largest hospital network to have the...",
      description:
        "National, 25th April, 2024: Apollo Hospitals Group announced its seventh consec...",
    ...
    },
    {
      date: "14 May 24",
      title:
        "Apollo Hospitals, Chennai has launched the Fatty Liver Clinic at the Liver...",
      description:
        "Fatty liver disease is rapidly becoming a major health concern in India. Studies...",
  ...
  const disclaimers = [
    {
      ...
      description:
        "It has been brought to our notice that some people have received emails purporting to offer money for kidney donation and misusing the name of Apollo Hospitals. The...",
    ...
    },
    {
      ...
      description:
        "Apollo Hospitals Enterprise Limited brings to your attention that persons not authorized by the Company are circulating/posting fake advertisements inviting...",
  ...
  return (
    <>
      ...
      <div className="hero-container">
        <Link href="/appointment" className="hero-button">
          BOOK APPOINTMENT
        </Link>
        <Link href="/health-check" className="hero-button">
          BOOK HEALTH CHECK
        </Link>
        <Link href="/lab-test" className="hero-button">
          BOOK LAB TEST
        </Link>
      ...
      <div className="why-choose-us">
        ...
        <p>
          Established by Dr Prathap C Reddy in 1983, Sandhya Nursing Home &
          Diagnostic Centre has a robust presence across the healthcare
          ecosystem. From routine wellness & preventive health care to
          innovative life-saving treatments and diagnostic services, Apollo
          Hospitals has touched more than 200 million lives from over 120
          countries.
        </p>
        <div className="stats">
      ...
      <footer>
        ...
        <div className="footer2">
          <p>
            © Copyright 2024. Sandhya Nursing Home & Diagnostic Centre. All
            Rights Reserved.
          </p>
